...
export const GroupsLocation1 = [20001,10001,10002,   // 分类页  轮播图  小图标
    10003,10004,10005,10006,10007,10008,10009,10010,10011,10012,10013,10014,    // 首页位置聚合区第一轮
    10015,10016,10017,10018,10019,10020,10021,10022,10023,10024,10025,10026    // 首页位置聚合区第二轮
];  
