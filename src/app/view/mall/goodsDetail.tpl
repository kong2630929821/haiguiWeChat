    ...
    <div w-class="body">
        ...
        <div w-class="goods-msg">
            ...
            <div w-class="goods-items">
                ...
                {{%===============普通商品和一般贸易商品可退货（活动商品除外）====================}}
                {{if !it.goods.isActGoods && (it.goods.goodsType == 0 || it.goods.goodsType == 3)}}
    ...
    <div w-class="fix-bottom">
        <div w-class="left">
            ...
            <div w-class="fix-item fix-item-1" on-tap="gotoCollect">
                <div style="position: relative;text-align: center;">
                    <img src="{{it.isLiked==1?'../../res/image/yishoucang.png':'../../res/image/shoucang.png'}}" w-class="collectImg"/>
