...
export const hBaoDesc = [
    ...
    '您可以获得平台赠送的护肤面膜套装，该套装每周领取一次，半年赠送完毕，每次领取，您需要额外支付邮费；',
...
export const hBaoPower = [
    ...
    { name: '10倍积分', img: 'power_integral.png', tpl: 'app-view-member-giftPage', fg: PowerFlag.integral },
    { name: '海宝邀请码', img: 'power_invite.png', tpl: 'app-view-member-giftPage', fg: PowerFlag.inviteCode },
    { name: '海宝返利', img: 'power_return.png', tpl: 'app-view-member-giftPage', fg: PowerFlag.rebate }
];

// 海王权益
export const hWangPower = [
    { name: '尊享礼包', img: 'power_gift.png', tpl: 'app-view-member-giftPage', fg: PowerFlag.gift },
    { name: '免费试用装', img: 'power_test.png', tpl: 'app-view-member-giftPage', fg: PowerFlag.free },
    { name: '线下课程', img: 'power_book.png',tpl: 'app-view-member-giftPage', fg: PowerFlag.offClass },
    ...
    { name: '海王邀请码', img: 'power_invite.png', tpl: 'app-view-member-giftPage', fg: PowerFlag.inviteCode },
